  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <Link href="/academy/schedule/sample-class" className="block rounded-3xl border border-white/80 bg-white/95 p-6 shadow-xl shadow-slate-200/60 transition hover:-translate-y-1 hover:border-blue-100 hover:shadow-2xl hover:shadow-blue-100/60">
